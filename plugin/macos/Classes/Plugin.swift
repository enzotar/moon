...
func dummyCallsToPreventTreeShaking() {
    ...
    rid_len_vec_txtcommand(nil);
    rid_get_item_vec_txtcommand(nil, 0);
    ...
    _to_dart_for_TxtCommand();
    __include_dart_for_vec_textcommandinput();
    rid_txtcommand_command_name(nil);
    rid_txtcommand_command_name_len(nil);
    rid_txtcommand_widget_name(nil);
    rid_txtcommand_widget_name_len(nil);
    rid_txtcommand_inputs(nil);
    rid_txtcommand_outputs(nil);
